...
status:
  ...
  - releaseName: postgres-operator
    releaseNamespace: postgres-operator
    status: Managing
  nextReconcileTime: "2026-04-23T05:20:07Z"
----------------------------------------------------
-----------------------------------------------------------------------------------
nginx failed & postgres isn't even attempted because continueOnError=false
...
status:
  ...
  - releaseName: postgres-operator
    releaseNamespace: postgres-operator
    status: Managing
  nextReconcileTime: "2026-04-22T21:41:06Z"

-----------------------------------------------------------------------------------
nginx & postgres both were successfully deployed but now some new changes is
in the process of being provisioned whether in one of them or both

nginx: 		Deployed -> Provisioning?
postgres: Deployed -> Provisioning?
-----------------------------------------------------------------------------------
status:
  dependencies: no dependencies
  featureSummaries:
  ...
  - releaseName: postgres-operator
    ...
    status: Managing
    valuesHash: yj0WO6sFU4GCciYUBWjzvvfqrBh869doeOC2Pp5EI1Y=
  nextReconcileTime: "2026-04-22T21:54:04Z"

-----------------------------------------------------------------------------------
nginx:     Deployed -> Failed -> Provisioning
postgres:  Deployed
-----------------------------------------------------------------------------------
status:
  dependencies: no dependencies
  ...
  - failureMessage: |
    ...
    featureID: Helm
    hash: 16CwFOvGTz25T2tUxoruIMDZaqv+AswuQylmSX/wKB8=
    lastAppliedTime: "2026-04-23T02:37:53Z"
    status: Provisioning
  helmReleaseSummaries:
  - releaseName: nginx
    releaseNamespace: nginx
  ...
  - releaseName: postgres-operator
    ...
    status: Managing
    valuesHash: yj0WO6sFU4GCciYUBWjzvvfqrBh869doeOC2Pp5EI1Y=
  nextReconcileTime: "2026-04-23T02:38:41Z"

------------------------------------------------------------------------------------
nginx:     Deployed -> Removing
postgres:  Deployed -> Removing
------------------------------------------------------------------------------------
status:
  dependencies: no dependencies
  featureSummaries:
  - featureID: Helm
    lastAppliedTime: "2026-04-23T02:38:41Z"
    status: Removing
  - featureID: Resources
    status: Removing
  - featureID: Kustomize
