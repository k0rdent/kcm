...
func (in *EmbeddedOCIRepositorySpec) DeepCopyInto(out *EmbeddedOCIRepositorySpec) {
	*out = *in
	if in.Reference != nil {
		in, out := &in.Reference, &out.Reference
		*out = new(v1beta2.OCIRepositoryRef)
		**out = **in
	}
	if in.LayerSelector != nil {
		in, out := &in.LayerSelector, &out.LayerSelector
		*out = new(v1beta2.OCILayerSelector)
		**out = **in
	}
	if in.Verify != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteSourceStatus) DeepCopyInto(out *RemoteSourceStatus) {
	*out = *in
	if in.Artifact != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteSourceStatus.
func (in *RemoteSourceStatus) DeepCopy() *RemoteSourceStatus {
	if in == nil {
		return nil
	}
	out := new(RemoteSourceStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServiceTemplateStatus) DeepCopyInto(out *ServiceTemplateStatus) {
	*out = *in
	if in.RemoteSourceStatus != nil {
		in, out := &in.RemoteSourceStatus, &out.RemoteSourceStatus
		*out = new(RemoteSourceStatus)
		(*in).DeepCopyInto(*out)
	}
	in.TemplateStatusCommon.DeepCopyInto(&out.TemplateStatusCommon)
