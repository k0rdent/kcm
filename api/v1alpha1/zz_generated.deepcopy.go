...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GVKSpec) DeepCopyInto(out *GVKSpec) {
	*out = *in
	if in.Resources != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GVKSpec.
func (in *GVKSpec) DeepCopy() *GVKSpec {
	if in == nil {
		return nil
	}
	out := new(GVKSpec)
