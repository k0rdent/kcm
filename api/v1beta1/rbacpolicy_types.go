...
//
// Scope: cluster-scoped grants only. A binding always produces a ClusterRole/ClusterRoleBinding
// pair, so there is currently no way to express a namespaced grant ("project X gets edit in
// namespace Y") — no Role, no RoleBinding, no binding a subject to a Role — and no ServiceAccount
